                    ...
                    <CardHeader>
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                            <div className="mb-4 sm:mb-0">
                                ...
                                <CardDescription>
                                    Detailed view of the Blue Team&apos;s activity.
                                </CardDescription>
                            </div>
                        ...
                        {!session ? (
                            <div className="grid md:grid-cols-2 gap-8">
                                ...
                                <Card>
                                    ...
                                    <CardFooter>
                                        <Button className="w-full" onClick={() => handleLogin(usernameLogIn, passwordLogIn)}>Log in</Button>
                                    </CardFooter>
                                </Card>
                            </div>
                        ) : (
